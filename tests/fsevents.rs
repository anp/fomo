...
mod timing_tests {
  ...
  fn fsevents_create_delete_file_1() {
    ...
    assert_eq!(recv_events_with_timeout(&rx, 1.0),
               vec![ (tdir.mkpath("file1"), op::CREATE, None) ]);
  ...
  fn fsevents_create_delete_file_2() {
    ...
    assert_eq!(recv_events_with_timeout(&rx, 2.0),
               vec![ (tdir.mkpath("file1"), op::CREATE, None) ]);
  ...
  fn fsevents_create_delete_file_4() {
    ...
    assert_eq!(recv_events_with_timeout(&rx, 4.0),
               vec![ (tdir.mkpath("file1"), op::CREATE, None) ]);
  ...
  fn fsevents_create_delete_file_8() {
    ...
    assert_eq!(recv_events_with_timeout(&rx, 8.0),
               vec![ (tdir.mkpath("file1"), op::CREATE, None) ]);
  ...
  fn fsevents_create_delete_file_16() {
    ...
    assert_eq!(recv_events_with_timeout(&rx, 16.0),
               vec![ (tdir.mkpath("file1"), op::CREATE, None) ]);
  ...
  fn fsevents_create_delete_file_32() {
    ...
    assert_eq!(recv_events_with_timeout(&rx, 32.0),
               vec![ (tdir.mkpath("file1"), op::CREATE, None) ]);
  ...
  fn fsevents_create_delete_file_64() {
    ...
    assert_eq!(recv_events_with_timeout(&rx, 64.0),
               vec![ (tdir.mkpath("file1"), op::CREATE, None) ]);
  ...
  fn fsevents_rename_rename_back_file_0() {
    ...
    assert_eq!(cookies.len(), 1);
    assert_eq!(actual,
               vec![ (tdir.mkpath("file1b"), op::RENAME, Some(cookies[ 0 ])),
