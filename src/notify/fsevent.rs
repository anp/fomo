...
//!
//! The FSEvents API provides a mechanism to notify clients about directories they ought
//! to re-scan
//! in order to keep their internal data structures up-to-date with respect to the true
//! state of
//! the file system. (For example, when files or directories are created, modified, or
//! removed.) It
//! sends these notifications "in bulk", possibly notifying the client of changes to
//! several
...
//! com/library/mac/documentation/Darwin/Reference/FSEvents_Ref/
...
// CFMutableArrayRef is a type alias to *mut libc::c_void, so FsEventWatcher is not
// Send/Sync
